...
function onTrigger(player,npc)
	...
	elseif(player:getVar("maatCap") == 120 and player:getVar("maatCapearned") == 0 and mJob <=15) then
...
--printf("RESULT: %u",option);
	...
	elseif(csid == 0x004a) then --maatCap
		player:addTitle(ULTIMATE_CHAMPION_OF_THE_WORLD);
		player:setVar("maatCapearned",1); --no idea how you get another cap if you accidentally toss it, try using this var for an event
