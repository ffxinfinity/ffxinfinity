...
public:
	...
	float			  xpRate;						// experience gain rate for character will override server default
	uint32			  walkSpeed;					// the walking speed of character this will override server default
	bool			  godModeOn;					// Godmode enabled
	uint32			  accountlevel;					// users account level
	uint32			  addSTR;						// Special modifiers from char_addons table
    uint32			  addDEX;						// Special modifiers from char_addons table
    uint32			  addAGI;						// Special modifiers from char_addons table
    uint32			  addINT;						// Special modifiers from char_addons table
    uint32			  addMND;						// Special modifiers from char_addons table
    uint32			  addVIT;						// Special modifiers from char_addons table
    uint32			  addCHR;						// Special modifiers from char_addons table
